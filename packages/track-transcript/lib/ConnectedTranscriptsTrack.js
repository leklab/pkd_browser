...
import { currentGene, currentTissue, currentTranscript, canonicalTranscript, maxTissueExpressions, transcripts, transcriptFanOut, strand, actions as geneActions } from '@broad/redux-genes';
...
export const ConnectedTranscriptsTrack = connect(mapStateToProps, mapDispatchToProps)(TranscriptsTrack);